...
class AppointmentAlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val id = intent.getStringExtra("appointment_id") ?: System.currentTimeMillis().toString()
        val title = intent.getStringExtra("appointment_title") ?: "Appointment"
        val notifId = id.hashCode()
        Notifications.showAppointment(context, notifId, title, System.currentTimeMillis(), id) // pass id
    }
}
